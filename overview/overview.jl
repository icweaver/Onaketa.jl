...
df_raw = CSV.read("overview.csv", DataFrame)

# ╔═╡ a86bc0dc-a61d-4f71-8547-9e9b732ef683
describe(df_raw, :nuniqueall, :nmissing, :eltype)

# ╔═╡ 0536fb38-0a00-4f5a-86c4-b552f4a0e543
@chain df_raw begin
	@rsubset :active_2021_fall
	@select :tutor_name :student_name
	sort(:tutor_name)
end

# ╔═╡ 4c05bf0d-fa86-4e2e-bdd4-4df6c299a3fd
@chain df_raw begin
	@rsubset :active_2022_spring
	@select :tutor_name :student_name
	sort(:tutor_name)
end

# ╔═╡ e0705c80-fff8-43f1-bb82-b749caab85d7
@chain df_raw begin
	@rsubset :active_2022_fall
	@select :tutor_name :student_name
	sort(:tutor_name)
end

# ╔═╡ fbbe7534-05ff-4c62-a7b7-c18d409674eb
@chain df_raw begin
	@rsubset :active_2023_spring
	@select :tutor_name :student_name
	sort(:tutor_name)
end

# ╔═╡ d192f322-c183-4afa-8273-ec3c25687525
# e.g., Fall 2020
function fmt_sem(s)
	_, year, season = tokens = split(s, '_')
	return "$(uppercasefirst(season)) $(year)"
end

# ╔═╡ b91501a8-c3ab-47b5-95ea-618c8c02d446
df_active = @chain df_raw[:, r"active"] begin
	stack(r"active")
	groupby(:variable)
...
# ╔═╡ 683b8437-df7c-4b4d-9fca-f301badf04fd
set_aog_theme!()
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "34e535387e9e9b611f93dd774d0f20d8ece75429"
