...
df_selected = let
	df = CSV.read("data/student_applications_2024.csv", DataFrame;
		header = 2,
	)
...
[breakdown(df, :student_race_ethnicity), breakdown(df_selected, :student_race_ethnicity)]

# ╔═╡ a310abb9-b763-4107-91f7-a4cf98218656
[breakdown(df, :student_grade), breakdown(df_selected, :student_grade)]

# ╔═╡ 5251b9fd-4f72-4b7b-b24a-16d5bd97758d
[breakdown(df, :course_name), breakdown(df_selected, :course_name)]

# ╔═╡ ca50e0ed-8239-4277-916b-90b2039252f7
[breakdown(df, :question_performance), breakdown(df_selected, :question_performance)]
