...
cat_rates = rand([("Tutoring", 30), ("Non-Tutoring", 20), ("Tutor Coordinator", 40), ("Social Media and Outreach Coordinator", 40)], N)

# ╔═╡ ea0a6802-382a-4a39-9989-c8c140bdc364
const student_names = [Faker.first_name() for _ ∈ 1:20]

# ╔═╡ 7822eea6-2c9e-4f58-bee9-882c2bb1afad
students() = rand(student_names)
...
tutor_names() = rand(["Ian Weaver", "Haley Carrasco", "Greg Cunningham", "Filipe Cerqueira", "Gianni Sims", "Pheona Williams", "Adia Imara"])
...
df = DataFrame(
	...
	reported_date = gen_f(dt_reported),
	duration = gen_f(dur),
	team_member = gen_f(tutor_names),
	category = [first(x) for x ∈ cat_rates],
	rate = [last(x) for x ∈ cat_rates],
...
git-tree-sha1 = "802e259ac5404ad9e143b43ff9dccc2aa09838e3"
